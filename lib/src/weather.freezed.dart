...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain)';
  }
...
class _$ForecastResponseData implements ForecastResponseData {
  ...
  @override
  String toString() {
    return 'ForecastResponse(country: $country, forecast: $forecast, latitude: $latitude, local_time: $local_time, location: $location, longitude: $longitude, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, forecast, latitude, local_time, location,
        longitude, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, forecast, latitude, local_time, location,
        longitude, region, timezone);
  }
...
abstract class ForecastResponseData implements ForecastResponse {
  const factory ForecastResponseData(
      ...
      double? longitude,
      String? region,
      String? timezone}) = _$ForecastResponseData;
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, condition: $condition, country: $country, daytime: $daytime, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, local_time: $local_time, location: $location, longitude: $longitude, region: $region, temp_c: $temp_c, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph)';
  }
